...
flags.DEFINE_string("data_dir", "C:/Users/cyw05/Desktop/FYP/Running_env/data", "path to datasets [e.g. $HOME/data]")
flags.DEFINE_string("out_dir", "C:/Users/cyw05/Desktop/FYP/Running_env/out", "Root directory for outputs [e.g. $HOME/out]")
...
flags.DEFINE_integer("img_num",100,"images number")
FLAGS = flags.FLAGS
...
def main(_):
  ...
  FLAGS.out_dir = FLAGS.out_dir.replace('\\', '/')
  FLAGS.checkpoint_dir = FLAGS.checkpoint_dir.replace('\\', '/')
  FLAGS.sample_dir = FLAGS.sample_dir.replace('\\', '/')
  #print(FLAGS.checkpoint_dir)
  #print(os.path.abspath(FLAGS.checkpoint_dir))
  #print("out_path:",FLAGS.checkpoint_dir)
  #print(os.path.exists(FLAGS.checkpoint_dir))
  #print(os.path.exists("./out"))
  #print(os.makedirs("./out"))


  if not os.path.exists(FLAGS.checkpoint_dir):
    os.makedirs(FLAGS.checkpoint_dir)
  if not os.path.exists(FLAGS.sample_dir): os.makedirs(FLAGS.sample_dir)
  print(os.path.join(FLAGS.out_dir, 'FLAGS.json').replace('\\', '/'))
  with open(os.path.join(FLAGS.out_dir, 'FLAGS.json').replace('\\', '/'), 'w+') as f:
  ...
  with tf.compat.v1.Session(config=run_config) as sess:
    ...
    #print("export",FLAGS.export)
    #print("freeze",FLAGS.freeze)
    #print("visualize",FLAGS.visualize)
    if FLAGS.train:
      dcgan.train(FLAGS)
    else:
